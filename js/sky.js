...
$(document).ready(function() {
    ...
    $(".header__ajax").load("navbar.html");
    // $(".footer--ajax").load("footer.html");
var ota_logo = $(".ota_group");
var testing = window.location.pathname;


$(".footer--ajax").load("footer.html", function(){
if(testing != "/sevenstar/index.html"){
    $(".ota_group").css("display","none");
}
})
